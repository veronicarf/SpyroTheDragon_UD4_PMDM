...
public class WorlAnimationView extends View {
    ...
    public WorlAnimationView(Context context) {
        super(context);
        init();
    }

    public WorlAnimationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        fadeOut.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (parent != null) {
                    parent.removeView(WorlAnimationView.this);
                }
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // **Misma separación con la barra de menú**
        float left = width * 0.25f;
        float top = height * 0.68f; // **Misma altura que el de "Mundos"**
        ...
        // **Flecha alineada con "Mundos"**
        float arrowX = width * 0.50f;
        ...
        canvas.drawText("Aquí podrás conocer ", textX, textY - 20, textPaint);
        canvas.drawText("todos los mundos", textX, textY + 20, textPaint);
        canvas.drawText("del juego de Spyro.", textX, textY + 60, textPaint);
    }
